            ...
            <div class="canvas">
                ...
                <div class="canBigbox" v-if="AIjson==''" @mouseenter="mouseInDiv" @mouseleave="mouseOutDiv">
                    ...
                    <div
                            ...
                            :style="{width: item.width*600/4724+'px',height:item.height*900/7087+'px','z-index': item.cnt,left: item.left,top: item.top,display: item.showEye?'block':'none',opacity:item.opacity?item.opacity:'1',transform: 'scale('+item.zoom+') rotateX('+item.rotateX+'deg) rotateY('+item.rotateY+'deg) rotateZ('+item.rotateZ+'deg)' }"
            ...
            <div class="operateBox">
                <ul class="bBox">
                    ...
                    <li>
                        <img
                                style="width: 1.25rem;"
                                @click.stop="opacityClick"
                                src="../../assets/image/flower/show.png"
                                alt
                        />
                        <span class="bOperate">透明度</span>
                        <input
                                @click.stop="noneClick"
                                v-model="opacity"
                                @keyup="trueopacity"
    ...
    export default {
        ...
        methods: {
            ...
            opacityClick() {
                let self = this;
                if (this.isClick) {
                    if (this.showopacity == "none") {
                        this.showopacity = "block";
                    } else {
                        this.showopacity = "none";
                    }
                } else {
                    this.showJump = true;
                    this.err = "请先选择图层";
                    ...
                    this.list.map(function(item, index) {
                        if (item.show) {
                            if (self.opacity == "") {
                                ...
                                console.log(self.opacity,self.list);
                            }
                            self.$forceUpdate();
                        }
                    });
