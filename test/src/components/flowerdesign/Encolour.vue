    ...
    <div class="colour">
        ...
        <div class="content">
            ...
            <div class="backBox">
                ...
                <button @click="exchange" class="exchange">Replace</button>
                <div class="btnBox">
...
export default {
    ...
    data(){
        return {
            ...
            height: '',
            showLoading: false,
            leftNav: [{name: 'Adding material',show: false},{name: 'Pattern',show: false},{name: 'Adding undertone',show: false},{name: 'AI Colour',show: true}],
            navIndex: 0,
            list: [],
            rightList: [],
            // 商品数据
            ...
            picType: 0,
            picName: '',
            btnList: [{name: 'Element',show: true},{name: 'Shading',show: false}],
            btnIndex: 0,
            path: '/Enflowerdesign'
        }
    },
