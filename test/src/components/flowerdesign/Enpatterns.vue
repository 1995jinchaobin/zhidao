...
export default {
    ...
    data(){
        return {
            ...
            height: '',
            showLoading: false,
            leftNav: [{name: 'Adding material',show: false},{name: 'Pattern',show: true},{name: 'Adding undertone',show: false},{name: 'AI Colour',show: false}],
            navIndex: 0,
            backList: [{name: ' Shared',show: true},{name: 'Location',show: false}],
            type: 1,
            list: [],
            // 页数
            cnt: 1,
