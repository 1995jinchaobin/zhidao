...
const router = new Router({
    routes: [
        // 以图识图主页
        {
            path:'/Knowledge',
            name: 'Knowledge',
            component: resolve => require(['../components/searchPicturePC/knowLedge'],resolve),
            children:[
                // 以图识图移动端
                {
                    path:'/Knowledge/Phone',
                    name:'knowLedgePhone',
                    component: resolve => require(['../components/knowledgeMapPhone/knowledgePhone'],resolve),
                    children: [
                        {
                            path: '/Knowledge/Phone/',
                            name: 'knowLedgePhoneIndex',
                            component: resolve => require(['../components/knowledgeMapPhone/index'],resolve),
                        },
                        {
                            path:'/Knowledge/Phone/Result',
                            name: 'knowLedgePhoneResult',
                            component: resolve => require(['../components/knowledgeMapPhone/knowledgeResult'],resolve)
                        },
                        {
                            path: '/Knowledge/Phone/Login',
                            name: 'knowLedgePhoneLogin',
                            component: resolve => require(['../components/knowledgeMapPhone/knowledgeLogin'],resolve)
                        }
                    ]
                },
                //以图搜图PC端
                {
                    path:'/Knowledge/Pc',
                    name: 'KnowledgePc',
                    component: resolve => require(['../components/searchPicturePC/knowledgePc'],resolve),
                    children: [
                        {
                            path:'/Knowledge/Pc/',
                            name:'KnowledgePcHome',
                            component:resolve => require(['../components/searchPicturePC/Home'],resolve),
                        },
                        {
                            path:'/Knowledge/Pc/addpicture',
                            name:'KnowledgePcAddPicture',
                            component:resolve => require(['../components/searchPicturePC/AddPicture'],resolve),
                        },
                        {
                            path:'/Knowledge/Pc/piclogin',
                            name:'KnowledgePcLogin',
                            component:resolve => require(['../components/searchPicturePC/Login'],resolve),
                        },
                        {
                            path:'/Knowledge/Pc/bindaccount',
                            name:'BindAccount',
                            component:resolve => require(['../components/searchPicturePC/BindAccount'],resolve),
                        },
                        {
                            path:'/Knowledge/Pc/History',
                            name:'History',
                            component: resolve => require(['../components/searchPicturePC/History'],resolve),
                        }
                    ]
                },
            ]
        ...
        //以图识图宣传页
        {
            path:'/picture',
            name: 'PictureHome',
            component: resolve => require(['../components/searchPicturePC/PictureHome'],resolve),
        },
        //口罩订单列表
        {
            path:'/maskOrderList',
            name:'MaskOrderList',
            component:resolve => require(['../components/masks/MaskOrderList'],resolve),
        },
        //口罩预定
        {
            path:'/orderMasks',
            name:'OrderMasks',
            component:resolve => require(['../components/masks/OrderMasks'],resolve),
        },
        // 设计师招募
        {
            path:'/maker',
        ...
        },
        {
            path:"/feedback",
            name:'Feedback',
            component: resolve => require(['../components/home/Feedback'],resolve),
        },
        {
            path: '/Task',
            name: 'Task',
        ...
        },
        {
            path: '/Demixing',
            name: 'Demixing',
            component: resolve => require(['../components/homepage/Demixing'],resolve),
        },
        {
            path: '/EnPaging',
            name: 'EnPaging',
