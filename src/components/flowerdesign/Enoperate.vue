            ...
            <div class="operateBox" :style="{height: height}">
                <ul class="bBox">
                    ...
                    <li>
                        ...
                        <input v-model="rotateDeg" @keyup="trueRotate" type="text" :style="{display: showRotate}" class="bInput" placeholder="Rotation angle">
                    </li>
                    <li>
                ...
                <div class="oBox">
                    <h4>Canvas Size<span>40*60CM 300DPI</span></h4>
                    <div class="backBox">
                        <div>
                            <span>Backcolor</span>
                            <img :src="backImg" alt="">
...
export default {
    ...
    data(){
        return {
            ...
            showLoading: false,
            // 左侧按钮内容
            leftNav: [{name: 'Adding material',show: false},{name: 'Pattern',show: false},{name: 'Adding undertone',show: false},{name: 'AI Colour',show: false}],
            navIndex: 0,
            list: [],
            rightList: [],
            // 判断是否点击
