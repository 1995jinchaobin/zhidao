<template>
  <div class="window">
    <Studiotap @showEnglish="changeEnglish" :studio="studio" :tabIndex="tabIndex"></Studiotap>
    <div class="studio">
      <div @click="qiehuan(0)" :class="type==0?'click':''">个人工作室</div>
      <div @click="qiehuan(1)" :class="type==1?'click':''">企业工作室</div>
    </div>
    <div class="shuru">
      <div class="page1">
        <div>
      ...
      <div class="page3">
        <button class="queding" @click="shangchuan">确定</button>
...
export default {
  ...
  data() {
    return {
      ...
      studioshuju: this.$route.query.studioshuju,
      src: "",
      src2: "",
      src3: "",
      file1: "", //文件格式
  ...
  methods: {
    ...
    qiehuan(e) {
      ...
      if (this.studio != 1 && this.studio != 0) {
        this.type = e;
      }
    },
    changeEnglish() {
    ...
    shangchuan() {
      ...
      if (!/^1[3456789]\d{9}$/.test(this.message.phone)) {
        ...
        this.showJump = true;
        this.err = "有必填项未填更新工作室需要重新上传所有文件";
        setTimeout(function() {
          self.showJump = false;
          self.err = "";
        }, 1500);
