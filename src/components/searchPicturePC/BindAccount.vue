<template>
    <div class="xiugai">
        <div class="header">
            ...
            <div class="tips">(  一个账号只可绑定五个子账号，您还可绑定账号为：{{5-parseInt(memberNum)}}  )</div>
        </div>
    ...
    export default {
        ...
        methods: {
            ...
            quxiao(index){
                ...
                let obj = {
                    url: this.all.baseUrl + "/new/userPicSearch/userPicUnBind",
                    formdata: formData
                };
            ...
            bind(){
                ...
                let obj = {};
                obj.url = this.all.baseUrl + '/new/userPicSearch/userPicBind';
            ...
            getList() {
                ...
                let self = this;
                let obj = {
                    url: this.all.baseUrl + "/new/userPicSearch/getUserPicBinds",
                    formdata: formData
                };
                self.getData(obj).then(res => {
                    if (res.data.status == 0) {
