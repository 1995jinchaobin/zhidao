    ...
    export default {
        ...
        methods:{
            ...
            getOssSign(){
                ...
                let url = self.type==1?self.actions.getFsOssSign:self.type==2?self.actions.getKtOssSign:getOssSignOfPicSearch
                let obj = {
            ...
            startUpload(){
                ...
                self.getData(obj).then(res=>{
                    ...
                    setTimeout(function(){
                        ...
                        self.succMsg = '';
                        //将路径值传给父组件
                        self.$emit('setImgPath',self.result.host+'/'+self.result.dir+ self.result.fileName+self.fileEnd)
                    },2000);
                });
            },
        }
