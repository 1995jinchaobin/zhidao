<template>
    <div class="shopselect">
        ...
        <div class="content">
            ...
            <div class="proBox">
                <p class="backP"><img src="../../assets/image/user/icon_back.png" alt="" @click="back"><span @click="back">Back</span></p>
                <div class="topBox">
                    <h4>Classify：</h4>
...
export default {
    ...
    data(){
        return {
            ...
            showLoading: false,
            // 左侧分类
            select: [{name: "Man's",show: true},{name: "Woman's",show: false},{name: "Children's",show: false},{name: "Home's",show: false},{name: 'other',show: false}],
            classIndex: 1,
            classFlag: 0,
            // 商品列表
            proList: [],
