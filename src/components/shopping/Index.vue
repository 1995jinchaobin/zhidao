...
export default {
    ...
    methods: {
        ...
        clickCount(item){
            ...
            formData.append('tbApp3dMaterialLibraryJygId',item.id);
            let obj = {
                url: this.all.baseUrl + '/app3dPatternsSoldByMallSellersClickJyg/save',
                formdata: formData
            }
        ...
        toDetail(index,type,listIndex,cnt){
            if(type==1){
                this.clickCount(this.proList[index])
                ...
                this.clickCount(this.officeList[index].list[listIndex])
