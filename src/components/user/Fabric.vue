    ...
    <div class="fabric">
            ...
            <div class="content">
                <ul class="productBox">
                    ...
                    <li v-for="(item,index) in list" :key="index">
                        ...
                        <div class="edit" @click="editClick(index)">编辑</div>
                    </li>
        ...
        <div class="editModel" v-if="showEdit">
            <div class="editBox">
                ...
                <div class="editBtn">
                    <span class="editDel" @click="delClassify" v-if="showDel">删除分类</span>
                    <div class="sureBox">
...
export default {
    ...
    methods: {
        ...
        delClassify(){
            ...
            let obj ={
                url: this.all.baseUrl + '/app3dFlowerMyUploadType/delete',
                formdata: formData
            }
            let self = this;
