                ...
                <ul v-if="list.length">
                    <li v-for="(item,index) in list" :key="index">
                        <div class="top">
                            ...
                            <span v-if="list[index].whetherPayment==0" class="status">Unpaid</span>
                            <span v-else class="status">Completion of the transaction</span>
                        </div>
                        ...
                        <div class="bottom">
                            <span v-if="list[index].whetherPayment==0" class="allMoney">Total：￥{{item.amount}}</span>
                            <div class="btnBox" v-if="list[index].whetherPayment==0">
                                <button class="btn" @click="toPay(item.id)">Payment</button>
                                <button @click="delOrder(item.id)" class="btn">Cancellation of order</button>
                            </div>
                            <div class="btnBox" v-else><button @click="delOrder(item.id)" class="btn">Delete</button></div>
                        </div>
                    </li>
                </ul>
    ...
    methods: {
        ...
        delOrder(str){
            ...
            if(this.userIndex==1){
                ...
                this.getData(obj).then(res => {
                    if(res.data.status == 0){
                        this.getAlert('Successful deletion');
                        this.list = [];
                        this.childList = [];
                        this.i = 1;
                        this.getDiffData();
