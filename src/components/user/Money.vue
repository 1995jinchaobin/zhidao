                ...
                <div v-if="showRegain == 1" class="bankInfoBox">
                    ...
                    <div class="callVerify">
                        ...
                        <div>
                            ...
                            <div class="etCheckCode" @click="getCheckCode" style="cursor: default;" v-show="!showCode">获取验证码</div>
                        </div>
                    </div>
                ...
                <div v-else-if="showRegain == -1">
                    ...
                    <div class="bindCode">
                        ...
                        <div>
                            ...
                            <div class="etCheckCode" @click="getCheckCode2" style="cursor: default;" v-show="!showCode2">获取验证码</div>
                        </div>
                        <div></div>
                    </div>
                    <p class="callPoint">温馨提示：<br>验证码发送到您所绑定的{{phone.substring(0,4)}}****{{phone.substring(7,11)}}手机上</p>
                ...
                <div  class="bankInfoBox">
                    ...
                    <div class="callVerify">
                        ...
                        <div>
                            ...
                            <div  class="etCheckCode" @click="getCheckCodePhone" style="cursor: default;" v-show="!showCodePhone">获取验证码</div>
                        </div>
                    </div>
...
<style scoped>
    ...
    .header .hraderBtn:hover,.etCheckCode:hover,.callBtn:hover,.surePay:hover{
