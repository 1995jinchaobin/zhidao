					...
					if (res.status == 200 && !res.data.status) {
						...
						resultTemp.map(function(item, i) {
							...
							while (tempItem.length != 0) {
								...
								if(resultList[index % resultList.length].elements[i].height){
                                    ...
                                    img.src = e.imageUrl;
                                    e.width=img.width;
                                    e.height = e.width*img.height/img.width;
								}

                                // e.height = e.width*resultList[0].elements[i].height/resultList[0].elements[i].width;
								e.id = resultList[index % resultList.length].elements[i].id;
                                // e.id = resultList[0].elements[i].id;
