...
export default {
  ...
  data() {
    return {
      ...
      arr: [
        { name: "Homepage", link: "/EnHomepage" },
        { name: "Cutout", link: "/Encut" },{ name: "AI Design", link: "/Enai" },
        { name: "Pattern Design", link: "/Enflowerdesign" },
        { name: "AI Colour", link: "/Enmatching" },
        { name: "Intelligent color separation", link: "/EnPaging" },
        { name: "3D Show", link: "/Enthreed" },
        { name: "Flower Mall", link: "/Enshopping" },
        
        { name: "Help Center", link: "/Ennew" },
        { name: "Task", link: "/EnTask" },
